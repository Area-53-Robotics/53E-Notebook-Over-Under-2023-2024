...
#page(
  ...
  #rect(
    ...
    #line(
      length: 100%,
      stroke: (cap: "round", dash: "solid"),
    )
    #v(8pt)
    #grid(columns: 2, gutter: 20pt, align(
      center,
      image(width: 90pt, height: 90pt, picture),
    ), align(left, body))
    ]
  ]
  ...
  #align(
    ...
    #grid(
      ...
      #nb_member(
        name: "Felix Hass",
        picture: "./assets/mugshots/felix.jpg",
      )[
        - 12th Grade
        - Team Leader
        - Programmer
      ...
      #nb_member(
        name: "Alan Morales",
        picture: "./assets/mugshots/alan.jpg",
      )[
        - 11th Grade
        - Design
        - Builder
      ...
      #nb_member(
        name: "John Kelly",
        picture: "./assets/mugshots/john.png",
      )[
        - 10th Grade
        - Design
        - Builder
      ...
      #nb_member(
        ...
        picture: "./assets/mugshots/meghana.jpg",
      )[
        - 9th Grade
        - Programmer
        ]
