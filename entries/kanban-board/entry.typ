...
Today we had a workshop presentation from one of the parents in our organization about project management. We talked about different types of methods for managing a project including waterfall and agile. Since our current workflow is very similar to agile we decided to make a kanban board to manage our team's progress.
...
Overall this will improve the speed with which we get stuff done, and keep us more organized.
