...
With the control scheme and curve strength selected we finished the implementation.
...
```
Since LemLib is already controlling our chassis  we decided to submit our drive code implementation to LemLib as it was currently lacking this feature. The relevant pull request can be found here:
