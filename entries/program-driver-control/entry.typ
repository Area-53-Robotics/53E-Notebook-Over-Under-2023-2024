...
#create_entry(
  ...
  Here's the code for tank drive: ```cpp
  ...
  ``` Since LemLib is already controlling our chassis we decided to submit our
  drive code implementation to LemLib as it was currently lacking this feature.
