...
We were in 13th place in eliminations so we planned on choosing our alliance partner. Our 
two top choices were 9080C and 53C, which was a tough choice to call. 
...
We had contemplated picking 53C to bring them up and possibly qualify them for states but 
ultimately we went with 9080C who had a bot very compatible to ours and had us as their number 
one option too. 
...
#pro-con(
  pros: [
    - Autonomous worked very well in most of our matches and we were able to learn more about winpoint importance.
  ...
  cons: [
    ...
    - We only had three team members present, so we were forced to rush several times and be aware of what was going on. 
  ],
)

Overall, our robot needed several improvements, the most important being the hang mechanism and supplying 
it with enough air to be able to retract it down and up multiple times, which it previously wasn't able to do. 
Another improvement we wanted to add was a stable intake as well as stronger intake banding. 
