...
#create_entry(
    ...
    [
      ...
      #grid(
        ...
        figure(caption: "The wheels can be positioned anywhere on the orange lines without adjusting distances in the code.", image("/assets/drivetrain/sensor-configs/3-tracking-wheels.svg"),),
        ...
        [
          ...
          #nb_admonition(type: "warning", [Our drivetrain does not have a perpendicular motor, so this configuration does not support tracking side to side.])
