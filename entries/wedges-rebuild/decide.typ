...
Our new wedge design is pretty simple. It involves a simple hinged piece that goes over our current ones. A piece of plastic will be cut out and put over the half cut to make sure that nothing gets through.

#figure(
  image("./cad-iso.png", width: 60%),
