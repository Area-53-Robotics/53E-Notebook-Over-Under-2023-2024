...
how to lift our robot to B tier. 
...
#grid(
  ...
  [
    == Pneumatic Lift
     ...
     Two pneumatic pistons attached to a lever could be used to lift the robot.
  ...
  [
    ...
    Power from drivetrain motors could be moved to power a lever which 
    could lift the robot. Moving the power would require PTO. 
