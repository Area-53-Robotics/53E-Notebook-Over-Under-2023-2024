...
#create_entry(
  ...
  #grid(
    ...
    This design uses a pneumatically activated claw to grab the triballs. It has passive flex wheels on the end to increase its compression and grip on the triballs.
    #nb_pro_con(
      pros: [
    ...
    This design uses a top down roller intake design, with flex wheels as the rollers.
    #nb_pro_con(
      pros: [
      - Compresses
      ],
    ...
    This design uses a top down roller intake design, and has sprockets connected by rubber bands as rollers.
    #nb_pro_con(
      pros: [
      - Compresses a lot
      ],
