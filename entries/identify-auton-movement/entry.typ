...
Now that we have position tracking we need to put it to use. Autonomous movement is a tricky problem to solve, especially now that we're tracking the robot in 2 dimensions instead of 1.
