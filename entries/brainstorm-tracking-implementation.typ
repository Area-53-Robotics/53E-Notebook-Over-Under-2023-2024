...
start_date: datetime(year: 2023, month: 7, day: 28),
  ...
  Now that we chose our sensor configuration we chose how we wanted to implement absolute tracking. The most popular method of doing this was first pioneered by team 5225, the $pi$lons. They wrote a document describing their implementation process, which can be found here: #link("http://thepilons.ca/wp-content/uploads/2018/10/Tracking.pdf").

  Since the release of this document there have been many libraries that have implemented it, each in their own way.
